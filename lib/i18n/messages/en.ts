...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.archivesDescription": "View and restore archived items here. Archived items are hidden from the sidebar.",
    "settings.archivedChats": "Chats",
    "settings.archivedWorkbenches": "Grading workbenches",
    "settings.noArchivedChats": "No archived chats",
    "settings.noArchivedWorkbenches": "No archived grading workbenches",
    "settings.restore": "Restore",
    "settings.deleteForever": "Delete",
    "settings.deletingForever": "Deleting…",
    "settings.deleteChatTitle": "Delete this chat permanently?",
    "settings.deleteChatConfirm": "This chat will be permanently removed from this computer and cannot be recovered.",
    "settings.expandArchives": "Show {count} more",
    "settings.collapseArchives": "Show less",
    ...
    "settings.sessionRequired": "Open a chat session to view this section",
    ...
    "appUpdate.releaseNotes": "Minerva v{version} is available. View release notes",
    ...
    "shortcut.orb": "Quick actions",
    "shortcut.close": "Close quick actions",
    "shortcut.theme": "Switch appearance",
    "shortcut.language": "Switch language",
    "workbench.viewRawProcess": "View raw process",
    "workbench.viewRawProcessHint": "View the complete Adapter, Marker, Evaluator, and Summarizer records",
    "workbench.returnCurrent": "Return to current chat",
    "workbench.returnCurrentHint": "Return to the compacted workbench conversation",
