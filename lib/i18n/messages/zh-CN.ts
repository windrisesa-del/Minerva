...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "设置",
    "settings.general": "常规",
    "settings.archives": "归档",
    "settings.archivesDescription": "在这里查看并恢复已经归档的内容。侧边栏不会显示归档内容。",
    "settings.archivedChats": "聊天记录",
    "settings.archivedWorkbenches": "批改工作台",
    "settings.noArchivedChats": "暂无已归档的聊天记录",
    "settings.noArchivedWorkbenches": "暂无已归档的批改工作台",
    "settings.restore": "恢复",
    "settings.deleteForever": "删除",
    "settings.deletingForever": "删除中…",
    "settings.deleteChatTitle": "永久删除这条聊天？",
    "settings.deleteChatConfirm": "聊天记录将从本机永久删除，无法恢复。",
    "settings.expandArchives": "展开其余 {count} 项",
    ...
    "settings.sessionRequired": "打开会话后才能查看此项",
    ...
    "appUpdate.releaseNotes": "Minerva v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    ...
    "shortcut.theme": "切换亮度",
    "shortcut.language": "切换语言",
    "workbench.viewRawProcess": "查看原始处理过程",
    "workbench.viewRawProcessHint": "查看 Adapter、Marker、Evaluator 与 Summarizer 的完整记录",
    "workbench.returnCurrent": "返回当前会话",
    "workbench.returnCurrentHint": "返回压缩后的工作台聊天会话",
    "history.full": "完整历史",
