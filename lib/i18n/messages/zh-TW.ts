...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "設定",
    "settings.general": "一般",
    "settings.archives": "封存",
    "settings.archivesDescription": "在這裡檢視並恢復已封存的內容。側邊欄不會顯示封存內容。",
    "settings.archivedChats": "聊天記錄",
    "settings.archivedWorkbenches": "批改工作台",
    "settings.noArchivedChats": "暫無已封存的聊天記錄",
    "settings.noArchivedWorkbenches": "暫無已封存的批改工作台",
    "settings.restore": "恢復",
    "settings.deleteForever": "刪除",
    "settings.deletingForever": "刪除中…",
    "settings.deleteChatTitle": "永久刪除這則聊天？",
    "settings.deleteChatConfirm": "聊天記錄將從本機永久刪除，無法恢復。",
    "settings.expandArchives": "展開其餘 {count} 項",
    "settings.collapseArchives": "收起",
    ...
    "settings.sessionRequired": "開啟工作階段後才能查看此項",
    ...
    "appUpdate.releaseNotes": "Minerva v{version} 已推出，查看版本資訊",
    "sidebar.hide": "隱藏側邊欄",
    "sidebar.show": "顯示側邊欄",
    ...
    "shortcut.orb": "快捷操作",
    "shortcut.close": "收起快捷操作",
    "shortcut.theme": "切換亮度",
    "shortcut.language": "切換語言",
    "workbench.viewRawProcess": "查看原始處理過程",
    "workbench.viewRawProcessHint": "查看 Adapter、Marker、Evaluator 與 Summarizer 的完整記錄",
    "workbench.returnCurrent": "返回目前會話",
    "workbench.returnCurrentHint": "返回壓縮後的工作台聊天會話",
    "history.full": "完整紀錄",
    ...
    "sidebar.rename": "重新命名",
    "sidebar.archivedSessions": "已封存",
    "sidebar.archiveSession": "封存工作階段",
    "sidebar.restoreSession": "還原工作階段",
